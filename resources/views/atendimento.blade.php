...
<body class="bg-light mt-5" style="background-color: #ffffff!important;" cz-shortcut-listen="true">
    ...
    <div class="container justify-content-center">
        ...
        <div class="col-md-8 order-md-1" style="display: flex;flex-direction: column;width: 100%;position: relative;min-width: 0px;overflow-wrap: break-word;border-radius: 20px;padding: 34px;margin: auto;">
            ...
            <form  class="needs-validation" id="formulariodeenvio" novalidate="" action="/pagamento" method="post">
                <div class="row">
                    @csrf
                ...
                <div class="col-md-6 mb-3" style="padding-left: 0px;float: left;">
                  ...
                  <span class="input-group-text">@</span>
                        ...
                        <input  type="text" required="" class="form-control bloqueioinput" id="email" name="email" value="{{$email}}" placeholder="E-mail">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input required="" type="text" maxlength="2" class="form-control" name="ddd" id="ddd" placeholder="DDD">
                    ...
                    <div class="col-md-8 mb-3" style="padding-right: 0;">
                        ...
                        <input type="text" name="numero" class="form-control" id="numero" placeholder="Whatsapp">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input required="" type="text" name="cidade" class="form-control" id="cidade" placeholder="Cidade">
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input required="" type="text" name="cep" class="form-control" id="cep" placeholder="CEP">
                        <input style="display: none;" name="company" value="{{$company}}"
        ...
        -->
                    ...
                    <input type="text" style="display: none;" value="{{$plano['id']}}" name="idplano" id="idplano">
            ...
            <div class="row">
                    <div class="col-8" id="" class="detalhes-plano">
                        ...
                        <h2 id="planname">{{$plano['name']}}</h2>
                        <ul>
                            <li>Quantidade de Dispositivos: <span id="qtdDispositivos">{{$plano['connections']}}</span></li>
                            <li>Quantidade de Filas: <span id="qtdFilas">{{$plano['queues']}}</span></li>
                            <li>Quantidade de Usuários: <span id="qtdUsers">{{$plano['users']}}</span></li>

                            <li>GPT Bot Mensagens Counter: <span id="gptBot">{{$plano['gpt_messages_counter']}}</span></li>
                        </ul>

                    </div>

                          <div class="col-4 justify-content-end" style="margin-top: 8px;" class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle" type="" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span id="planoSelecionado">Mudar plano</span>
                    </button>
                    <div id="dropDown" class="dropdown-menu" aria-labelledby="dropdownMenuButton">

                            @foreach ($planos as $plano)

                            <a class="dropdown-item" data-value="{{ $plano['id'] }}" href="#">{{ $plano['name'] }}</a>
                            @endforeach
                ...
                <hr class="mb-4">
                <button   onclick="respostaCPF" class="btn btn-primary btn-lg btn-block" id="botaoComprar" type="submit" style="background: #25d366;border: 0;height: 60px;">Finalizar Compra <span><strong>R$:</strong><span id="valor">{{$plano['value']}},00</span></span></button>
            </form>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p id="piximg"></p>
                    <p id="pixtxt" style=""></p>
                    <p style="margin-left: auto;margin-right: auto;display: flex;width: 92px;" id="pixstatus" style=""></p>

                    <p id="pixLoad"></p>


                <div style="display: none;width: 200px;height: 220px;margin-left: auto;margin-right: auto;" id="pixSucesso" class="check-container">
                    ...
                    <p style="margin-left: auto;margin-right: auto;display: none;width: 178px;" id="pixstatustext" style="">Pagamento aprovado!</p>
